...
DB_PATH = os.path.join(TEMP_DIR, "test_expensetracker.db")
...
@mcp.tool()
async def list_expense_in_range(start_date, end_date):
...
@mcp.tool()
async def edit_expense(expense_id, date, amount, category, subcategory='', note=''):
